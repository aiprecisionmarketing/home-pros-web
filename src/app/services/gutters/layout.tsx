...
export const metadata: Metadata = {
  ...
  description: "Professional gutter cleaning in Stony Plain and Spruce Grove. Prevent water damage, basement flooding, and ice dams. From $149. Family-owned, WCB insured. Call (825) 435-9977.",
  openGraph: {
