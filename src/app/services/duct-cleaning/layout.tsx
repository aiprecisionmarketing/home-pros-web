...
export const metadata: Metadata = {
  ...
  description: "Professional duct cleaning in Stony Plain, Spruce Grove, and Parkland County. All vents included in our flat rate. Improve air quality and reduce allergies. Call (825) 435-9977.",
  openGraph: {
