                ...
                <div className="container px-4 md:px-6 mx-auto relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-4">
                            Complete furnace and duct cleaning for just <strong className="text-white">$345 flat rate</strong> — every single vent included, zero surprises. Family-owned, WCB insured, and trusted by 1,200+ Parkland County homeowners.
                        </p>
            ...
            <section className="py-16 bg-white">
                <div className="container px-4 md:px-6 mx-auto">
                    <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary/5 to-red-50 border-2 border-primary/20 rounded-2xl p-10 text-center">
                        <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">$345 Flat Rate — Everything Included</h2>
            ...
            <section className="py-20 bg-gradient-to-r from-slate-900 to-slate-800 text-white text-center">
                <div className="container px-4 md:px-6 mx-auto max-w-3xl">
                    ...
                    <p className="text-xl text-slate-300 mb-8">
                        $345 flat rate. Every vent included. No hidden fees. Serving Stony Plain, Spruce Grove, Parkland County, and Greater Edmonton.
                    </p>
                    <a href="tel:18254359977">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "description": "Professional furnace cleaning in Stony Plain, Spruce Grove, and Parkland County. $345 flat rate, unlimited vents.",
                        "provider": {
                            "@type": "HVACBusiness",
